const struct Evolution gEvolutionTable[NUM_SPECIES][EVOS_PER_MON] =
{
    ...
    [SPECIES_PAWMO]                 = {{EVO_LEVEL_STEPS, 1000, SPECIES_PAWMOT}},
    ...
    [SPECIES_GIMMIGHOUL]            = {{EVO_GHOLDENGO, ITEM_GIMMIGHOUL_COIN, SPECIES_GHOLDENGO}},
    [SPECIES_POLTCHAGEIST]          = {{EVO_ITEM, ITEM_UNREMARKABLE_TEACUP, SPECIES_SINISTCHA}},
#endif
