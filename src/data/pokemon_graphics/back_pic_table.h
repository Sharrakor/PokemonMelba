const struct CompressedSpriteSheet gMonBackPicTable[NUM_SPECIES + 1] =
{
	...
	SPECIES_SPRITE(WOCHIEN, gMonBackPic_WoChien),
	SPECIES_SPRITE(CHIENPAO, gMonBackPic_ChienPao),
	SPECIES_SPRITE(TINGLU, gMonBackPic_TingLu),
	SPECIES_SPRITE(CHIYU, gMonBackPic_ChiYu),
	...
	SPECIES_SPRITE(IRONLEAVES, gMonBackPic_IronLeaves),
