const struct CompressedSpritePalette gMonShinyPaletteTable[NUM_SPECIES + 1] =
{
	...
	SPECIES_SHINY_PAL(WOCHIEN, gMonShinyPalette_WoChien),
	SPECIES_SHINY_PAL(CHIENPAO, gMonShinyPalette_ChienPao),
	SPECIES_SHINY_PAL(TINGLU, gMonShinyPalette_TingLu),
	SPECIES_SHINY_PAL(CHIYU, gMonShinyPalette_ChiYu),
	...
	SPECIES_SHINY_PAL(WALKINGWAKE, gMonShinyPalette_WalkingWake),
	SPECIES_SHINY_PAL(IRONLEAVES, gMonShinyPalette_IronLeaves),
