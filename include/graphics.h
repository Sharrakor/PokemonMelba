...
#endif
#if P_GEN_9_POKEMON == TRUE
extern const u32 gMonIcon_Sprigatito[];
extern const u32 gMonIcon_Floragato[];
extern const u32 gMonIcon_Meowscarada[];
extern const u32 gMonIcon_Fuecoco[];
extern const u32 gMonIcon_Crocalor[];
extern const u32 gMonIcon_Skeledirge[];
extern const u32 gMonIcon_Quaxly[];
extern const u32 gMonIcon_Quaxwell[];
extern const u32 gMonIcon_Quaquaval[];
extern const u32 gMonIcon_Lechonk[];
extern const u32 gMonIcon_Oinkologne[];
extern const u32 gMonIcon_Tarountula[];
extern const u32 gMonIcon_Spidops[];
extern const u32 gMonIcon_Nymble[];
extern const u32 gMonIcon_Lokix[];
extern const u32 gMonIcon_Pawmi[];
extern const u32 gMonIcon_Pawmo[];
extern const u32 gMonIcon_Pawmot[];
extern const u32 gMonIcon_Tandemaus[];
extern const u32 gMonIcon_Maushold[];
extern const u32 gMonIcon_Fidough[];
extern const u32 gMonIcon_Dachsbun[];
extern const u32 gMonIcon_Smoliv[];
extern const u32 gMonIcon_Dolliv[];
extern const u32 gMonIcon_Arboliva[];
extern const u32 gMonIcon_Squawkabilly[];
extern const u32 gMonIcon_Nacli[];
extern const u32 gMonIcon_Naclstack[];
extern const u32 gMonIcon_Garganacl[];
extern const u32 gMonIcon_Charcadet[];
extern const u32 gMonIcon_Armarouge[];
extern const u32 gMonIcon_Ceruledge[];
extern const u32 gMonIcon_Tadbulb[];
extern const u32 gMonIcon_Bellibolt[];
extern const u32 gMonIcon_Wattrel[];
extern const u32 gMonIcon_Kilowattrel[];
extern const u32 gMonIcon_Maschiff[];
extern const u32 gMonIcon_Mabosstiff[];
extern const u32 gMonIcon_Shroodle[];
extern const u32 gMonIcon_Grafaiai[];
extern const u32 gMonIcon_Bramblin[];
extern const u32 gMonIcon_Brambleghast[];
extern const u32 gMonIcon_Toedscool[];
extern const u32 gMonIcon_Toedscruel[];
extern const u32 gMonIcon_Klawf[];
extern const u32 gMonIcon_Capsakid[];
extern const u32 gMonIcon_Scovillain[];
extern const u32 gMonIcon_Rellor[];
extern const u32 gMonIcon_Rabsca[];
extern const u32 gMonIcon_Flittle[];
extern const u32 gMonIcon_Espathra[];
extern const u32 gMonIcon_Tinkatink[];
extern const u32 gMonIcon_Tinkatuff[];
extern const u32 gMonIcon_Tinkaton[];
extern const u32 gMonIcon_Wiglett[];
extern const u32 gMonIcon_Wugtrio[];
extern const u32 gMonIcon_Bombirdier[];
extern const u32 gMonIcon_Finizen[];
extern const u32 gMonIcon_Palafin[];
extern const u32 gMonIcon_Varoom[];
extern const u32 gMonIcon_Revavroom[];
extern const u32 gMonIcon_Cyclizar[];
extern const u32 gMonIcon_Orthworm[];
extern const u32 gMonIcon_Glimmet[];
extern const u32 gMonIcon_Glimmora[];
extern const u32 gMonIcon_Greavard[];
extern const u32 gMonIcon_Houndstone[];
extern const u32 gMonIcon_Flamigo[];
extern const u32 gMonIcon_Cetoddle[];
extern const u32 gMonIcon_Cetitan[];
extern const u32 gMonIcon_Veluza[];
extern const u32 gMonIcon_Dondozo[];
extern const u32 gMonIcon_Tatsugiri[];
extern const u32 gMonIcon_Annihilape[];
extern const u32 gMonIcon_Clodsire[];
extern const u32 gMonIcon_Farigiraf[];
extern const u32 gMonIcon_Dudunsparce[];
extern const u32 gMonIcon_Kingambit[];
extern const u32 gMonIcon_GreatTusk[];
extern const u32 gMonIcon_ScreamTail[];
extern const u32 gMonIcon_BruteBonnet[];
extern const u32 gMonIcon_FlutterMane[];
extern const u32 gMonIcon_SlitherWing[];
extern const u32 gMonIcon_SandyShocks[];
extern const u32 gMonIcon_IronTreads[];
extern const u32 gMonIcon_IronBundle[];
extern const u32 gMonIcon_IronHands[];
extern const u32 gMonIcon_IronJugulis[];
extern const u32 gMonIcon_IronMoth[];
extern const u32 gMonIcon_IronThorns[];
extern const u32 gMonIcon_Frigibax[];
extern const u32 gMonIcon_Arctibax[];
extern const u32 gMonIcon_Baxcalibur[];
extern const u32 gMonIcon_Gimmighoul[];
extern const u32 gMonIcon_Gholdengo[];
extern const u32 gMonIcon_WoChien[];
extern const u32 gMonIcon_ChienPao[];
extern const u32 gMonIcon_TingLu[];
extern const u32 gMonIcon_ChiYu[];
extern const u32 gMonIcon_RoaringMoon[];
extern const u32 gMonIcon_IronValiant[];
extern const u32 gMonIcon_Koraidon[];
extern const u32 gMonIcon_Miraidon[];
extern const u32 gMonIcon_WalkingWake[];
extern const u32 gMonIcon_IronLeaves[];
extern const u32 gMonIcon_Dipplin[];
extern const u32 gMonIcon_Poltchageist[];
extern const u32 gMonIcon_Sinistcha[];
extern const u32 gMonIcon_Okidogi[];
extern const u32 gMonIcon_Munkidori[];
extern const u32 gMonIcon_Fezandipiti[];
extern const u32 gMonIcon_Ogerpon[];
#endif
...
#endif
//#if P_GEN_9_POKEMON == TRUE
//extern const u32 gMonFootprint_Sprigatito[];
//extern const u32 gMonFootprint_Floragato[];
//extern const u32 gMonFootprint_Meowscarada[];
//extern const u32 gMonFootprint_Fuecoco[];
//extern const u32 gMonFootprint_Crocalor[];
//extern const u32 gMonFootprint_Skeledirge[];
//extern const u32 gMonFootprint_Quaxly[];
//extern const u32 gMonFootprint_Quaxwell[];
//extern const u32 gMonFootprint_Quaquaval[];
//extern const u32 gMonFootprint_Lechonk[];
//extern const u32 gMonFootprint_Oinkologne[];
//extern const u32 gMonFootprint_Tarountula[];
//extern const u32 gMonFootprint_Spidops[];
//extern const u32 gMonFootprint_Nymble[];
//extern const u32 gMonFootprint_Lokix[];
//extern const u32 gMonFootprint_Pawmi[];
//extern const u32 gMonFootprint_Pawmo[];
//extern const u32 gMonFootprint_Pawmot[];
//extern const u32 gMonFootprint_Tandemaus[];
//extern const u32 gMonFootprint_Maushold[];
//extern const u32 gMonFootprint_Fidough[];
//extern const u32 gMonFootprint_Dachsbun[];
//extern const u32 gMonFootprint_Smoliv[];
//extern const u32 gMonFootprint_Dolliv[];
//extern const u32 gMonFootprint_Arboliva[];
//extern const u32 gMonFootprint_Squawkabilly[];
//extern const u32 gMonFootprint_Nacli[];
//extern const u32 gMonFootprint_Naclstack[];
//extern const u32 gMonFootprint_Garganacl[];
//extern const u32 gMonFootprint_Charcadet[];
//extern const u32 gMonFootprint_Armarouge[];
//extern const u32 gMonFootprint_Ceruledge[];
//extern const u32 gMonFootprint_Tadbulb[];
//extern const u32 gMonFootprint_Bellibolt[];
//extern const u32 gMonFootprint_Wattrel[];
//extern const u32 gMonFootprint_Kilowattrel[];
//extern const u32 gMonFootprint_Maschiff[];
//extern const u32 gMonFootprint_Mabosstiff[];
//extern const u32 gMonFootprint_Shroodle[];
//extern const u32 gMonFootprint_Grafaiai[];
//extern const u32 gMonFootprint_Bramblin[];
//extern const u32 gMonFootprint_Brambleghast[];
//extern const u32 gMonFootprint_Toedscool[];
//extern const u32 gMonFootprint_Toedscruel[];
//extern const u32 gMonFootprint_Klawf[];
//extern const u32 gMonFootprint_Capsakid[];
//extern const u32 gMonFootprint_Scovillain[];
//extern const u32 gMonFootprint_Rellor[];
//extern const u32 gMonFootprint_Rabsca[];
//extern const u32 gMonFootprint_Flittle[];
//extern const u32 gMonFootprint_Espathra[];
//extern const u32 gMonFootprint_Tinkatink[];
//extern const u32 gMonFootprint_Tinkatuff[];
//extern const u32 gMonFootprint_Tinkaton[];
//extern const u32 gMonFootprint_Wiglett[];
//extern const u32 gMonFootprint_Wugtrio[];
//extern const u32 gMonFootprint_Bombirdier[];
//extern const u32 gMonFootprint_Finizen[];
//extern const u32 gMonFootprint_Palafin[];
//extern const u32 gMonFootprint_Varoom[];
//extern const u32 gMonFootprint_Revavroom[];
//extern const u32 gMonFootprint_Cyclizar[];
//extern const u32 gMonFootprint_Orthworm[];
//extern const u32 gMonFootprint_Glimmet[];
//extern const u32 gMonFootprint_Glimmora[];
//extern const u32 gMonFootprint_Greavard[];
//extern const u32 gMonFootprint_Houndstone[];
//extern const u32 gMonFootprint_Flamigo[];
//extern const u32 gMonFootprint_Cetoddle[];
//extern const u32 gMonFootprint_Cetitan[];
//extern const u32 gMonFootprint_Veluza[];
//extern const u32 gMonFootprint_Dondozo[];
//extern const u32 gMonFootprint_Tatsugiri[];
//extern const u32 gMonFootprint_Annihilape[];
//extern const u32 gMonFootprint_Clodsire[];
//extern const u32 gMonFootprint_Farigiraf[];
//extern const u32 gMonFootprint_Dudunsparce[];
//extern const u32 gMonFootprint_Kingambit[];
//extern const u32 gMonFootprint_GreatTusk[];
//extern const u32 gMonFootprint_ScreamTail[];
//extern const u32 gMonFootprint_BruteBonnet[];
//extern const u32 gMonFootprint_FlutterMane[];
//extern const u32 gMonFootprint_SlitherWing[];
//extern const u32 gMonFootprint_SandyShocks[];
//extern const u32 gMonFootprint_IronTreads[];
//extern const u32 gMonFootprint_IronBundle[];
//extern const u32 gMonFootprint_IronHands[];
//extern const u32 gMonFootprint_IronJugulis[];
//extern const u32 gMonFootprint_IronMoth[];
//extern const u32 gMonFootprint_IronThorns[];
//extern const u32 gMonFootprint_Frigibax[];
//extern const u32 gMonFootprint_Arctibax[];
//extern const u32 gMonFootprint_Baxcalibur[];
//extern const u32 gMonFootprint_Gimmighoul[];
//extern const u32 gMonFootprint_Gholdengo[];
//extern const u32 gMonFootprint_WoChien[];
//extern const u32 gMonFootprint_ChienPao[];
//extern const u32 gMonFootprint_TingLu[];
//extern const u32 gMonFootprint_ChiYu[];
//extern const u32 gMonFootprint_RoaringMoon[];
//extern const u32 gMonFootprint_IronValiant[];
//extern const u32 gMonFootprint_Koraidon[];
//extern const u32 gMonFootprint_Miraidon[];
//extern const u32 gMonFootprint_WalkingWake[];
//extern const u32 gMonFootprint_IronLeaves[];
//extern const u32 gMonFootprint_Dipplin[];
//extern const u32 gMonFootprint_Poltchageist[];
//extern const u32 gMonFootprint_Sinistcha[];
//extern const u32 gMonFootprint_Okidogi[];
//extern const u32 gMonFootprint_Munkidori[];
//extern const u32 gMonFootprint_Fezandipiti[];
//extern const u32 gMonFootprint_Ogerpon[];
//#endif
